  ...
  return (
    <Box
      styleSheet={{
        ...
        maxWidth: {
          sm: theme.space.xcontainer_sm,
        },
        overflow: 'hidden', // Evita scroll
        position: 'relative', // Permite o posicionamento absoluto dentro
        marginRight: '-160px',
        height: "100%",
      }}
    >
      ...
      >
        <Box
          styleSheet={{
            ...
            transform: {
              lg: 'translateX(25%)', // Opcional: ajusta o quanto da imagem fica para fora
            },
          }}
        >
          <Image
